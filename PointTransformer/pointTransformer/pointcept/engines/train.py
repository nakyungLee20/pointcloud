...
from pointcept.datasets import build_dataset, point_collate_fn, collate_fn, collate_dim
...
class Trainer(TrainerBase):
    ...
    def train(self):
        with EventStorage() as self.storage:
            ...
            for self.epoch in range(self.start_epoch, self.max_epoch):
                ...
                # => after epoch
                self.after_epoch()
                print(f"{self.epoch}/45 Training")
            # => after train
            self.after_train()
    ...
    def run_step(self):
        ...
        torch.cuda.empty_cache()
        print("1 Step After training loss:", loss.item())
